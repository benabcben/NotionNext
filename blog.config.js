...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'bieji', // 您的昵称 例如 
  BIO: process.env.NEXT_PUBLIC_BIO || 'Can sing, dance, and rap, but can't play basketball., // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'bieji.notion.site', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion,  微信公众号，博客', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个Raper, Hi，我是一个Self-employed,Hi，我是一个人,欢迎来到我的博客🎉',
